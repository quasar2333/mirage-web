  ...
  return (
    ...
    >
      <div className="p-2 sm:p-3 flex items-center justify-between flex-shrink-0 h-[60px]">
        <a href="#" className="flex items-center gap-2 pl-2 no-underline hover:opacity-80 transition-opacity">
            <img src={APP_LOGO_SVG_DATA_URI} alt="Mirage Logo" className="w-6 h-6" />
            <span className="text-lg font-semibold text-[var(--theme-text-primary)]">Mirage镜像站</span>
        </a>
